...
hadoop jar /opt/hadoop-3.2.1/share/hadoop/tools/lib/hadoop-streaming-3.2.1.jar \
  ...
  -partitioner org.apache.hadoop.mapred.lib.KeyFieldBasedPartitioner \
  -file q4-b/mapper.py -mapper q4-b/mapper.py \
  -file q4-b/reducer.py -reducer q4-b/reducer.py \
  -input input -output output-q4-mapred-job-1
...
hadoop jar /opt/hadoop-3.2.1/share/hadoop/tools/lib/hadoop-streaming-3.2.1.jar \
  ...
  -partitioner org.apache.hadoop.mapred.lib.KeyFieldBasedPartitioner \
  -mapper cat \
  -file q4-b/reducer2.py  -reducer q4-b/reducer2.py \
  -input output-q4-mapred-job-1/part-00000 -output output-q4-b
